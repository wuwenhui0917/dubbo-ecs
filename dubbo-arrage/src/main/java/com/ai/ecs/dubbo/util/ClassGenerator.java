...
public class ClassGenerator {
    ...
    /**
     * 预先编译ognl编码，保证ognl正确性
     * @param ognl
     * @throws EBPSException
     */
    public static void compierOgnl(String ognl) throws EBPSException {
        String rootognl = EBPS.PARAMSTYPE.OGNL_ROOT+ognl;
        try {
            Ognl.getValue(rootognl,new HashMap());
        } catch (OgnlException e) {
            e.printStackTrace();
            throw new EBPSException(2001,rootognl+"编译失败");
        }
    }
